...
class TransunionDemographics(Base):
    """Transunion TruAudience demographic enrichment — monthly full refresh.

    Records with match_confidence < etl.transunion_min_confidence are flagged
    excluded=True and zero-imputed in the feature store.
    """
