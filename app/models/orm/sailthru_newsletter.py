...
class SailthruNewsletter(Base):
    """Sailthru email engagement staging table — full refresh weekly snapshot.

    user_id is nullable because identity stitching (email → user_id) runs
    after ingestion. ETL truncates this table before each load.
    """
